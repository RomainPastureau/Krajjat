...
.. list-table:: General shortcuts
    ...
    * - Pause/Unpause
      - .. image:: ../img/icons32/space.png
    * - Increase the display speed by 0.25
      - .. image:: ../img/icons32/+.png
    * - Decrease the display speed by 0.25
      - .. image:: ../img/icons32/-.png
    * - Next pose (manual or paused only)
      - .. image:: ../img/icons32/right.png
    * - Previous pose (manual or paused only)
      - .. image:: ../img/icons32/left.png
    * - Show/hide corrected joints*
      - .. image:: ../img/icons32/c.png
    * - Assign new random background color*
      - .. image:: ../img/icons32/g.png
    * - Show/hide bottom joints*
      - .. image:: ../img/icons32/i.png
    * - Assign new random default joint color*
      - .. image:: ../img/icons32/j.png
    * - Show/hide lines*
      - .. image:: ../img/icons32/l.png
    * - Show/hide pose index
      - .. image:: ../img/icons32/p.png
    * - Save the current window content as PNG
      - .. image:: ../img/icons32/s.png
    * - Move the animation*
      - .. image:: ../img/icons32/left_click.png
        .. image:: ../img/icons32/plus.png
        .. image:: ../img/icons32/move.png
...
.. list-table:: Size shortcuts
    ...
    * - Operation
      - Key or key combination
    * - Zoom in*
      - .. image:: ../img/icons32/scroll_up.png
    * - Zoom out*
      - .. image:: ../img/icons32/scroll_down.png
    * - Increase default joint size*
      - .. image:: ../img/icons32/ctrl.png
        .. image:: ../img/icons32/plus.png
        .. image:: ../img/icons32/scroll_up.png
...
Functions
---------
.. autofunction:: krajjat.display_functions.common_displayer
.. autofunction:: krajjat.display_functions.sequence_reader
.. autofunction:: krajjat.display_functions.sequence_comparer
.. autofunction:: krajjat.display_functions.pose_reader
.. autofunction:: krajjat.display_functions._process_events
.. autofunction:: krajjat.display_functions.save_video_sequence
